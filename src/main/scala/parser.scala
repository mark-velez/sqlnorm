...
import sqlnorm.Ast.{DataType, Update, Composed, Insert}
import scala.util.parsing.combinator._
import scala.reflect.runtime.universe.{Type, typeOf}
import java.sql.{Types => JdbcTypes}

/**
 * SqlParser is a type class which allows us to derive a parser from a dialect
 * @tparam T Concrete dialect
 */
trait SqlParser[T <: Dialect] extends RegexParsers with Ast.Unresolved with PackratParsers {
  import Ast._
...
object SqlParser {
  ...
  implicit object MysqlParser extends SqlParser[MysqlDialect] {
